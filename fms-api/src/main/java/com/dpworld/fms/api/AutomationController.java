...
public class AutomationController {
  ...
  @DeleteMapping("/reservations/{id}") @PreAuthorize("hasAnyRole('DISPATCHER','ADMINISTRATOR')")
  ...
  @GetMapping("/audit") @PreAuthorize("hasRole('ADMINISTRATOR')") public Object audit() { return runtime.auditEvents(); }
